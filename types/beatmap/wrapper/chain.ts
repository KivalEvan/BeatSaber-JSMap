...
export interface IWrapChainAttribute<T extends Record<keyof T, unknown> = Record<string, unknown>>
...
export interface IWrapChain<T extends Record<keyof T, unknown> = Record<string, unknown>>
