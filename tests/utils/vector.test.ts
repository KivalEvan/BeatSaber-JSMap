import * as vector from '../../src/utils/math/vector.ts';
...
Deno.test('Add Vector', () => {
   ...
   assertEquals(vector.vectorAdd([1, 2, 3, 4], { x: -1, y: 0, z: 1, w: 0 }), [
      0,
      2,
      4,
      4,
...
Deno.test('Subtract Vector', () => {
   ...
   assertEquals(vector.vectorSub([1, 2, 3, 4], { x: -1, y: 0, z: 1, w: 0 }), [
      2,
      2,
      2,
      4,
...
Deno.test('Multiply Vector', () => {
   ...
   assertEquals(vector.vectorMul([2, 2, 2, 2], { x: 1, y: 2, z: -3, w: 5.5 }), [
      2,
      4,
      -6,
      11,
...
Deno.test('Divide Vector', () => {
   ...
   assertEquals(vector.vectorDiv([2, 2, 2], [1, 2, -3, 5.5]), [
      2,
      1,
      -0.6666666666666666,
   ]);
