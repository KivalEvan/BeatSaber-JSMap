import type { GetPositionFn, MirrorFn } from '../../../beatmap/schema/shared/types/functions.ts';
...
import { isInverseSlider } from '../../../beatmap/helpers/core/baseSlider.ts';
import { mirrorCoordinate, resolveGridPosition } from '../../../beatmap/helpers/core/gridObject.ts';
import { LINE_COUNT } from '../../../beatmap/misc/remaps.ts';
