import type { IWrapBasicEventTypesForKeywords } from '../../beatmap/schema/wrapper/types/basicEventTypesForKeywords.ts';
import type { DeepPartial } from '../../types/utils.ts';
import { deepCopy } from '../../utils/misc/json.ts';
import { BaseItem } from './abstract/baseItem.ts';
import { createBasicEventTypesForKeywords } from '../../beatmap/schema/wrapper/basicEventTypesForKeywords.ts';
