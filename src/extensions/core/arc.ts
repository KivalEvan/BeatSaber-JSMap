import type { GetAngleFn, MirrorFn } from '../../beatmap/schema/shared/types/functions.ts';
import type { IWrapArc } from '../../beatmap/schema/wrapper/types/arc.ts';
import { deepCopy } from '../../utils/misc/json.ts';
import { mirrorArcMidAnchor } from '../../beatmap/helpers/core/arc.ts';
import {
   mirrorNoteDirectionHorizontally,
   resolveNoteAngle,
} from '../../beatmap/helpers/core/baseNote.ts';
