import type { IWrapLightRotationEvent } from '../schema/wrapper/types/lightRotationEvent.ts';
import { deepCopy } from '../../utils/misc/json.ts';
import { BaseObject } from './abstract/baseObject.ts';
import { createLightRotationEvent } from '../schema/wrapper/lightRotationEvent.ts';
