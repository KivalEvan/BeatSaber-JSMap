...
export function InfoSongSchema(): v.ObjectSchema<
   InferObjectEntries<IInfoSong>,
   undefined
> {
   return v.object<InferObjectEntries<IInfoSong>>({
...
export function InfoAudioSchema(): v.ObjectSchema<
   InferObjectEntries<IInfoAudio>,
   undefined
> {
   return v.object<InferObjectEntries<IInfoAudio>>({
...
export function InfoBeatmapAuthorsSchema(): v.ObjectSchema<
   InferObjectEntries<IInfoBeatmapAuthors>,
   undefined
> {
   return v.object<InferObjectEntries<IInfoBeatmapAuthors>>({
...
export function InfoDifficultySchema(): v.ObjectSchema<
   InferObjectEntries<IInfoBeatmap>,
   undefined
> {
   return v.object<InferObjectEntries<IInfoBeatmap>>({
...
export function InfoSchema(): v.ObjectSchema<
   ...
   undefined
> {
   return entity<InferObjectEntries<IInfo>>((x) => x.version || '4.0.0', {
