...
export function ObjectSchema(): v.ObjectSchema<
   InferObjectEntries<IObject>,
   undefined
> {
   return v.object<InferObjectEntries<IObject>>({
...
export function ObjectLaneSchema(): v.ObjectSchema<
   InferObjectEntries<IObjectLane>,
   undefined
> {
   return v.object<InferObjectEntries<IObjectLane>>({
      b: field(v.optional(v.number()), {
         version: '4.0.0',
      }),
      i: field(v.optional(v.pipe(v.number(), v.integer())), {
...
export function ObjectChainSchema(): v.ObjectSchema<
   InferObjectEntries<IObjectChain>,
   undefined
> {
   return v.object<InferObjectEntries<IObjectChain>>({
...
export function ObjectArcSchema(): v.ObjectSchema<
   InferObjectEntries<IObjectArc>,
   undefined
> {
   return v.object<InferObjectEntries<IObjectArc>>({
      hb: field(v.optional(v.number()), {
         version: '4.0.0',
      }),
