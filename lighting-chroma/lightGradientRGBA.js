...
// colorStepEasing affects colorEasing, if you wish the colorEasing to not be affected, change the 'currentRGBA' assignment to
// interpolateColor(startRGBA, endRGBA, colorEasing(normalize(lerp(0, length, colorStepEasing(normalize(itColorStep, 0, maxColorStep))), 0, length)));
// dirty one liner
